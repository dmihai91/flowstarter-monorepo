          ...
          <RadixDialog.Content asChild>
            <motion.div
              className={classNames(
                ...
                'bg-flowstarter-elements-background-depth-1 rounded-3xl shadow-2xl',
                'flex overflow-hidden focus:outline-none ring-1 ring-flowstarter-elements-borderColor/50',
              )}
              ...
              <RadixDialog.Close asChild>
                <button
                  className={classNames(
                    ...
                    'bg-flowstarter-elements-background-depth-2 text-flowstarter-elements-textTertiary',
                    'hover:bg-flowstarter-elements-item-backgroundHover hover:text-flowstarter-elements-textPrimary',
