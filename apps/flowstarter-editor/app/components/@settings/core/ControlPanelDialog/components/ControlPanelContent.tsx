...
function LoadingFallback() {
  return (
    <div className="flex items-center justify-center h-full">
      <div className="flex items-center gap-3 text-flowstarter-elements-textSecondary">
...
function TabContent({ tab }: { tab: TabType }) {
  switch (tab) {
    ...
    default:
      return (
        <div className="flex items-center justify-center h-full text-flowstarter-elements-textSecondary">
  ...
  return (
    <div
      className={classNames(
        ...
        'bg-flowstarter-elements-background-depth-2 px-8',
      )}
    >
      {/* Header */}
      <div className="sticky top-0 z-layer-3 pt-8 pb-6 mb-4 bg-transparent backdrop-blur-xl">
        <div className="min-h-9 flex flex-col gap-2">
          <h2 className="text-2xl font-bold truncate text-flowstarter-elements-textPrimary tracking-tight">
