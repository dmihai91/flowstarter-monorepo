      ...
      <li key={tab.id} className="first:mt-0">
        <button
          ...
          className={classNames(
            ...
            'focus-visible:outline-2 focus-visible:outline-flowstarter-elements-borderColor',
            'transition-all duration-200',
            isActive
              ? 'bg-flowstarter-elements-item-backgroundActive text-flowstarter-elements-textPrimary font-semibold shadow-sm'
              : 'bg-transparent hover:bg-flowstarter-elements-background-depth-2 text-flowstarter-elements-textSecondary hover:text-flowstarter-elements-textPrimary',
          )}
        >
  ...
  return (
    <aside
      className={classNames(
        ...
        'bg-flowstarter-elements-background-depth-2 border-r border-flowstarter-elements-borderColor',
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        {primaryTabs.length > 0 && (
          <section className="flex flex-col">
            <div className="sticky top-0 bg-flowstarter-elements-background-depth-2 z-layer-1 text-flowstarter-elements-textTertiary text-xs font-semibold hidden md:block p-2 md:p-4">
              Settings
            </div>
