  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-flowstarter-elements-textPrimary">{title}</h3>
          {description && <p className="text-sm text-flowstarter-elements-textSecondary mt-1">{description}</p>}
        </div>
      </div>
      {children}
    </motion.div>
