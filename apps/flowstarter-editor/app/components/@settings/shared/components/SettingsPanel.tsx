    ...
    >
      {(title || description) && (
        <div className="flex items-center gap-3">
          ...
          <div>
            {title && <h4 className="text-base font-semibold text-flowstarter-elements-textPrimary">{title}</h4>}
            {description && <p className="text-sm text-flowstarter-elements-textSecondary mt-0.5">{description}</p>}
          </div>
        </div>
      )}
