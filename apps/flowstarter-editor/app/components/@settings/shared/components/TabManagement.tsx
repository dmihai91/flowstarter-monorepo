...
import { tabConfigurationStore, setSelectedTab } from '~/lib/stores/settings';
      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-flowstarter-elements-textPrimary">Tab Management</h4>
              <p className="text-sm text-flowstarter-elements-textSecondary">Configure visible tabs and their order</p>
            </div>
          </div>
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className={classNames(
                ...
                'placeholder-flowstarter-elements-textTertiary',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              ...
              <span className="text-sm font-medium text-flowstarter-elements-textPrimary">Default Tabs</span>
            </div>
          )}
          ...
          {filteredTabs
            ...
            .map((tab, index) => (
              <motion.div
                key={tab.id}
                className={classNames(
                  'rounded-lg border bg-flowstarter-elements-background text-flowstarter-elements-textPrimary',
                  'bg-flowstarter-elements-background-depth-2',
                  'hover:bg-flowstarter-elements-background-depth-3',
                  'transition-all duration-200',
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'bg-flowstarter-elements-background-depth-3 group-hover:bg-flowstarter-elements-background-depth-4',
                      'transition-all duration-200',
                      tab.visible ? 'text-blue-500' : 'text-flowstarter-elements-textSecondary',
                    )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-medium text-flowstarter-elements-textPrimary group-hover:text-blue-500 transition-colors">
                            {TAB_LABELS[tab.id]}
                          </h4>
                          {BETA_TABS.has(tab.id) && <BetaLabel />}
                        </div>
                        <p className="text-xs text-flowstarter-elements-textSecondary mt-0.5">
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              ...
              <span className="text-sm font-medium text-flowstarter-elements-textPrimary">Optional Tabs</span>
            </div>
          )}
