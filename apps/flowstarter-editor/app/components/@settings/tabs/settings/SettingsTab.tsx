        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <SettingsCard variant="gradient" className="p-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <label className="text-sm font-bold text-flowstarter-elements-textPrimary">Project Identity</label>
              </div>
                ...
                <div className="relative flex-1 group">
                  <input
                    ...
                    className={classNames(
                      ...
                      'bg-white dark:bg-black/20 border border-flowstarter-elements-borderColor',
                      'text-flowstarter-elements-textPrimary placeholder-gray-400 dark:placeholder-gray-600',
                      'focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10',
                      'group-hover:border-flowstarter-elements-borderColorActive',
                    )}
                  />
              ...
              <p className="text-xs text-flowstarter-elements-textSecondary">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-flowstarter-elements-textPrimary uppercase tracking-wider">
                ...
                <button
                  ...
                  className={classNames(
                    ...
                    selectedAgent === agent.id && !agent.comingSoon
                      ...
                      : 'bg-white dark:bg-black/20 border-flowstarter-elements-borderColor hover:border-blue-300 dark:hover:border-blue-700',
                  )}
                >
                  ...
                  <p className="text-xs text-flowstarter-elements-textSecondary leading-relaxed">{agent.desc}</p>
          ...
          <div className="space-y-4">
                ...
                <button
                  ...
                  className={classNames(
                    ...
                    visibility === option.id
                      ...
                      : 'bg-white dark:bg-black/20 border-flowstarter-elements-borderColor hover:border-blue-300 dark:hover:border-blue-800',
                  )}
                >
                  <div className="flex items-start gap-4 h-full relative z-10">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-flowstarter-elements-textSecondary leading-relaxed">{option.desc}</p>
                    </div>
                  </div>
                  {visibility === option.id && (
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-blue-500/5 border border-blue-500/10 dark:bg-blue-500/10">
              ...
              <p className="text-xs text-flowstarter-elements-textSecondary leading-relaxed">
                Looking to share your site privately? Use the{' '}
                <span className="font-bold text-flowstarter-elements-textPrimary underline decoration-blue-500/30">
                  Share
                </span>{' '}
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-sm font-bold text-flowstarter-elements-textPrimary uppercase tracking-wider">
                    Maintenance
                  </label>
                </div>
                <button
              ...
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-flowstarter-elements-textPrimary mb-1">
