...
export const AssistantMessage = memo(({ content, annotations, messageId, onRewind, onFork }: AssistantMessageProps) => {
  ...
  return (
    <div className="w-full break-words" style={{ minWidth: '300px' }}>
          ...
          {onRewind && (
            <WithTooltip tooltip="Revert to this message">
              <button
                ...
                className="i-ph:arrow-u-up-left text-lg text-flowstarter-elements-textSecondary hover:text-flowstarter-elements-textPrimary transition-colors"
              />
            </WithTooltip>
          )}
          {onFork && (
            <WithTooltip tooltip="Fork chat from this message">
              <button
                ...
                className="i-ph:git-fork text-lg text-flowstarter-elements-textSecondary hover:text-flowstarter-elements-textPrimary transition-colors"
              />
            </WithTooltip>
          )}
        </div>
