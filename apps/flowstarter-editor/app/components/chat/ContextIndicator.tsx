  ...
  return (
    <div className="context-indicator mb-3">
      <button
        ...
        style={{ color: 'var(--flowstarter-elements-textSecondary)' }}
        onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--flowstarter-elements-textPrimary)')}
        onMouseLeave={(e) => (e.currentTarget.style.color = 'var(--flowstarter-elements-textSecondary)')}
      >
        ...
        {tokenCount && (
          <>
            <span style={{ color: 'var(--flowstarter-elements-borderColor)' }}>•</span>
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <div
              className="mt-2 p-3 rounded-lg border border-flowstarter-elements-borderColor"
              style={{ backgroundColor: 'var(--flowstarter-elements-bg-depth-2)' }}
            >
              {files && files.length > 0 && (
                <div className="mb-3">
                  <div className="text-xs font-medium text-flowstarter-elements-textSecondary mb-2">
                    Files included:
                  </div>
                      ...
                      return (
                        <WithTooltip key={normalized} tooltip={normalized}>
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2 py-1 text-xs text-flowstarter-elements-textPrimary rounded hover:opacity-80 transition-colors"
                            style={{ backgroundColor: 'var(--flowstarter-elements-bg-depth-3)' }}
                          >
              ...
              {summary && (
                <div>
                  ...
                  <div
                    className="text-xs text-flowstarter-elements-textPrimary p-2 rounded max-h-32 overflow-y-auto"
                    style={{ backgroundColor: 'var(--flowstarter-elements-bg-depth-3)' }}
                  >
              ...
              {tokenCount && (
                <div className="mt-3 pt-3 border-t border-flowstarter-elements-borderColor">
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-flowstarter-elements-textSecondary">
                    <span>Prompt: {tokenCount.prompt.toLocaleString()}</span>
                    <span>Completion: {tokenCount.completion.toLocaleString()}</span>
                    <span className="font-medium text-flowstarter-elements-textPrimary">
