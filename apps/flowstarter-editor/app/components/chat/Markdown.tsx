  ...
  const components = useMemo(() => {
    return {
      div: ({ className, children, node, ...props }) => {
        if (className?.includes('__FlowstarterArtifact__')) {
        ...
        if (className?.includes('__FlowstarterThinking__')) {
...
export const stripCodeFenceFromArtifact = (content: string) => {
  if (
    !content ||
    (!content.includes('__FlowstarterArtifact__') &&
      !content.includes('__FlowstarterThinking__') &&
  ...
  const artifactLineIndex = lines.findIndex(
    (line) =>
      line.includes('__FlowstarterArtifact__') ||
      line.includes('__FlowstarterThinking__') ||
