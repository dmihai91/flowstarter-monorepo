      ...
      <DropdownMenu.Trigger asChild>
        <button
          ...
          className={classNames(
            ...
            'hover:bg-flowstarter-elements-item-backgroundActive hover:text-flowstarter-elements-item-contentActive',
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className={classNames(
            ...
            'bg-flowstarter-elements-background-depth-2 backdrop-blur-xl',
            'border border-flowstarter-elements-borderColor',
          ...
          sideOffset={8}
        >
          <div className="px-2 py-1 mb-1 text-[9px] font-bold uppercase tracking-wider text-flowstarter-elements-textTertiary">
            Prompt Template
          </div>
          {prompts.map((prompt) => (
            <DropdownMenu.Item
              ...
              className={classNames(
                ...
                'hover:bg-flowstarter-elements-item-backgroundActive/80',
                promptId === prompt.id
                  ? 'bg-flowstarter-elements-item-backgroundAccent text-flowstarter-elements-textPrimary'
                  : 'text-flowstarter-elements-textSecondary',
              )}
                ...
                <div
                  className={classNames(
                    ...
                    promptId === prompt.id
                      ...
                      : 'bg-flowstarter-elements-bg-depth-3 border-flowstarter-elements-borderColor text-flowstarter-elements-textTertiary',
                  )}
                >
                  <div
                    className={classNames(
