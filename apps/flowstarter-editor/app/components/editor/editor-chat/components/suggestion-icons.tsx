 ...
 * Suggestion Icons
 *
 * SVG icon mapping for suggested reply buttons.
 * Extracted from SuggestedReplies to keep file sizes manageable.
 */

import type { SuggestedReply } from '~/components/editor/editor-chat/types';
...
export function getSuggestionIcon(suggestion: SuggestedReply): React.ReactNode {
