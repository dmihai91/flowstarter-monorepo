...
import type { InitialChatState, ChatMessage } from '../types';
...
const MOCK_MESSAGES: ChatMessage[] = [
  { id: '1', role: 'user', content: 'I run a bakery', timestamp: 1700000000000 },
  { id: '2', role: 'assistant', content: 'Great! Tell me more about your bakery.', timestamp: 1700000001000 },
];
 ...
 */
function needsWorkspaceRestoration(state: Partial<InitialChatState>): boolean {
 ...
 */
function getRestorationStrategy(state: Partial<InitialChatState>): 'full' | 'files-only' | 'none' {
...
describe('validateInitialState', () => {
  ...
  it('accepts minimal valid state', () => {
    const minimalState = { step: 'describe', projectUrlId: 'test-123' };
