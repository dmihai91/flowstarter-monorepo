...
describe('useEditorChatState - Logo Select Pattern', () => {
  it('should call handlePersonalizationComplete when font is selected before logo skip', () => {
    ...
    expect(handlePersonalizationCompleteMock).toHaveBeenCalledWith({ name: 'Modern' }, { type: 'none' });
  });
  ...
  it('should work with rapid font + logo selection (separate act calls)', () => {
    ...
    expect(handlePersonalizationCompleteMock).toHaveBeenCalledWith({ name: 'Elegant' }, { type: 'none' });
  });
  ...
  it('should work with uploaded logo type', () => {
    ...
    expect(handlePersonalizationCompleteMock).toHaveBeenCalledWith({ name: 'Bold' }, { type: 'uploaded' });
  });
  ...
  it('should work with generated logo type', () => {
    ...
    expect(handlePersonalizationCompleteMock).toHaveBeenCalledWith({ name: 'Classic' }, { type: 'generated' });
  });
  ...
  it('should handle multiple font changes before logo selection', () => {
    ...
    expect(handlePersonalizationCompleteMock).toHaveBeenCalledWith({ name: 'Bold' }, { type: 'none' });
  });
});
