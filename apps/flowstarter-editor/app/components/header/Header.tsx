...
export function Header() {
  ...
  return (
    <>
      <header className="flex items-center justify-between p-3 h-12 flex-1 bg-flowstarter-elements-background-depth-2 border-b border-transparent">
        <div className="flex items-center gap-2 z-logo text-flowstarter-elements-textPrimary cursor-pointer">
        ...
        <div className="flex items-center gap-2">
          <a href="https://fazier.com/launches/Flowstarter" target="_blank">
