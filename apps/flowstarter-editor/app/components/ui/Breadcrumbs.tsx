      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-flowstarter-elements-textPrimary dark:text-flowstarter-elements-textPrimary-dark'
              : 'text-flowstarter-elements-textSecondary dark:text-flowstarter-elements-textSecondary-dark hover:text-flowstarter-elements-textPrimary dark:hover:text-flowstarter-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-flowstarter-elements-textTertiary dark:text-flowstarter-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
