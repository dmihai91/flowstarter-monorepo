...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-flowstarter-elements-textPrimary hover:text-flowstarter-elements-textPrimary',
...
export const DropdownSeparator = () => (
  <DropdownMenu.Separator className="h-px bg-flowstarter-elements-borderColor my-1" />
);
