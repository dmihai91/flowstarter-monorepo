        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-flowstarter-elements-background-depth-2 dark:bg-flowstarter-elements-background-depth-3 text-flowstarter-elements-textPrimary dark:text-flowstarter-elements-textPrimary-dark hover:bg-flowstarter-elements-background-depth-3 dark:hover:bg-flowstarter-elements-background-depth-4 border border-flowstarter-elements-borderColor dark:border-flowstarter-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
