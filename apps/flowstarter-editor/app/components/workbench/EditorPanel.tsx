        ...
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={15}>
          <PanelGroup direction="horizontal">
            <Panel
              ...
              minSize={13}
              collapsible
              className="border-r border-flowstarter-elements-borderColor shadow-sm"
            >
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-flowstarter-elements-textSecondary px-1">
                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-flowstarter-elements-background-depth-3 py-0.5 px-2 rounded-lg text-sm font-medium text-flowstarter-elements-textTertiary hover:text-flowstarter-elements-textPrimary data-[state=active]:text-flowstarter-elements-textPrimary',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
            ...
            <Panel className="flex flex-col shadow-sm" defaultSize={80} minSize={20}>
                    ...
                    {activeFileUnsaved && (
                      <div className="flex gap-1 ml-auto -mr-1.5">
                        <PanelHeaderButton onClick={onFileSave}>
                          <div className="i-ph:floppy-disk-duotone text-flowstarter-elements-textPrimary" />
                          Save
                        </PanelHeaderButton>
                        <PanelHeaderButton onClick={onFileReset}>
                          <div className="i-ph:clock-counter-clockwise-duotone text-flowstarter-elements-textPrimary" />
                          Reset
                        </PanelHeaderButton>
                      </div>
                    )}
              ...
              <div className="h-full flex-1 overflow-hidden modern-scrollbar">
                <Suspense
                  fallback={
                    <div className="h-full flex items-center justify-center text-flowstarter-elements-textTertiary">
