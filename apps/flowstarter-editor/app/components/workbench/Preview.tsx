...
export const Preview = memo(() => {
  ...
  // Daytona preview source (only supported mode)
  const daytonaPreview = useStore(workbenchStore.daytonaPreview);

  // Use Daytona preview URL
  ...
  const ResizeHandle = ({ side }: { side: ResizeSide }) => {
    ...
    return (
      <div
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--flowstarter-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--flowstarter-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--flowstarter-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
          ...
          {activePreview && activePreview.baseUrl ? (
            ...
            <div className="flex w-full h-full justify-center items-center bg-flowstarter-elements-background-depth-1 text-flowstarter-elements-textPrimary">
              <div className="text-center">
                ...
                <div className="text-sm text-flowstarter-elements-textSecondary">
