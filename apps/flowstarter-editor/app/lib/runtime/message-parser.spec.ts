...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out Flowstarter artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <Flowstarter', 'Foo bar '],
      ['Foo bar <bolta', 'Foo bar <bolta'],
      ['Foo bar <FlowstarterA', 'Foo bar '],
      ['Foo bar <FlowstarterArtifacs></FlowstarterArtifact>', 'Foo bar <FlowstarterArtifacs></FlowstarterArtifact>'],
      ['Before <oltArtfiact>foo</FlowstarterArtifact> After', 'Before <oltArtfiact>foo</FlowstarterArtifact> After'],
      [
        'Before <FlowstarterArtifactt>foo</FlowstarterArtifact> After',
        'Before <FlowstarterArtifactt>foo</FlowstarterArtifact> After',
      ],
    ])('should correctly parse chunks and strip out Flowstarter artifacts (%#)', (input, expected) => {
      runTest(input, expected);
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <FlowstarterArtifact title="Some title" id="artifact_1">foo bar</FlowstarterArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <FlowstarterArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</FlowstarterArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</FlowstarterArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</FlowstarterArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/FlowstarterArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <FlowstarterArtifact title="Some title" id="artifact_1">foo</FlowstarterArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <FlowstarterArtifact title="Some title" id="artifact_1"><FlowstarterAction type="shell">npm install</FlowstarterAction></FlowstarterArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <FlowstarterArtifact title="Some title" id="artifact_1"><FlowstarterAction type="shell">npm install</FlowstarterAction><FlowstarterAction type="file" filePath="index.js">some content</FlowstarterAction></FlowstarterArtifact> After',
        {
          output: 'Before  After',
