...
describe('generateFallbackName', () => {
  it('should generate warm names for life coach descriptions', () => {
    const descriptions = ['life coach website', 'a life coaching business', 'personal coaching services'];
  ...
  it('should generate warm names for spa/wellness descriptions', () => {
    const descriptions = ['massage therapy', 'spa and wellness', 'yoga studio', 'therapy practice'];
  ...
  it('should generate warm names for restaurant/cafe descriptions', () => {
    const descriptions = ['restaurant', 'coffee shop', 'cafe', 'bakery'];
  ...
  it('should not generate corporate-sounding names', () => {
    ...
    const testDescriptions = ['massage', 'coaching', 'fitness', 'tech startup', 'consulting', 'generic business'];
