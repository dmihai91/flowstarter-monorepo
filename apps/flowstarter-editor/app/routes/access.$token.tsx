  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center' }}>
        ...
        />
        <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.8)' }}>{message}</p>
        <style>{`
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: '400px', padding: '32px' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '12px' }}>Access Link Invalid</h1>
        <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.7)', marginBottom: '24px' }}>{message}</p>
