import type { RepositoryIdentity } from "@flowstarter/editor-contracts";
import { Cache, Duration, Effect, Exit, Layer } from "effect";
import { detectGitHostingProviderFromRemoteUrl, normalizeGitRemoteUrl } from "@flowstarter/editor-shared/git";
