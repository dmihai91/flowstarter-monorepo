...
export const CLIENT_SETTINGS_STORAGE_KEY = "flowstarter-editor:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "flowstarter-editor:saved-environment-registry:v1";
