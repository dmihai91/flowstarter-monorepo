...
import { parseScopedThreadKey, scopedThreadKey } from "@flowstarter/editor-client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@flowstarter/editor-contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "flowstarter-editor:terminal-state:v1";
