...
const PERSISTED_STATE_KEY = "flowstarter-editor:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "flowstarter-editor:renderer-state:v8",
  "flowstarter-editor:renderer-state:v7",
  "flowstarter-editor:renderer-state:v6",
  "flowstarter-editor:renderer-state:v5",
  "flowstarter-editor:renderer-state:v4",
  "flowstarter-editor:renderer-state:v3",
