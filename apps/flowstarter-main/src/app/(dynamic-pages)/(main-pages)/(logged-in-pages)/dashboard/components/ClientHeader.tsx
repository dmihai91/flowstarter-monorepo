...
export function ClientHeader() {
  ...
  return (
    <ScrollAwareHeader className="z-[100] h-16 border-b border-gray-200/30 dark:border-white/10" transparentClass="bg-white/95 dark:bg-[#0a0a0c]/95 backdrop-blur-sm border-b border-gray-200/40 dark:border-white/10" scrolledClass="bg-white/60 dark:bg-[#0a0a0c]/60 backdrop-blur-2xl backdrop-saturate-150 shadow-[0_1px_2px_rgba(0,0,0,0.03)] border-b border-gray-200/30 dark:border-white/10">
