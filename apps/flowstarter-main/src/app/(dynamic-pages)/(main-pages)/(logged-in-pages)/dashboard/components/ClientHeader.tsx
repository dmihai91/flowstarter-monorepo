...
export function ClientHeader() {
  ...
  return (
    <ScrollAwareHeader className="z-[100] h-16" transparentClass="bg-white dark:bg-[var(--flow-bg-secondary)] border-b border-gray-200/20 dark:border-transparent" scrolledClass="bg-white/80 dark:bg-[var(--flow-bg-secondary)] backdrop-blur-2xl backdrop-saturate-150 shadow-[0_1px_2px_rgba(0,0,0,0.03)] border-b border-gray-200/20 dark:border-transparent">
