...
export function ClientHeader() {
  ...
  return (
    <ScrollAwareHeader className="z-[100] h-16" transparentClass="bg-white/95 dark:bg-[var(--flow-bg-secondary)] backdrop-blur-sm border-b border-gray-200/30 dark:border-transparent" scrolledClass="bg-white/60 dark:bg-[var(--flow-bg-secondary)]/95 backdrop-blur-2xl backdrop-saturate-150 shadow-[0_1px_2px_rgba(0,0,0,0.03)] border-b border-gray-200/30 dark:border-white/[0.04]">
