...
export function CTAButton({
  ...
  const variants = {
    ...
    secondary:
      'border border-[var(--landing-card-border)] text-gray-700 dark:text-gray-200 hover:border-[var(--purple-primary-light)] dark:hover:border-[var(--purple-primary-light)] hover:text-[var(--purple-primary)] dark:hover:text-[var(--purple-primary-light)] bg-[var(--landing-card-bg)] backdrop-blur-sm',
  };
