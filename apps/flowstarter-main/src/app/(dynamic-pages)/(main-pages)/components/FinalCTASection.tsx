...
export function FinalCTASection() {
  ...
  return (
    <>
        {/* Final CTA */}
        <section className="py-8 lg:py-18 mt-8 lg:mt-10 relative overflow-hidden bg-gradient-to-br from-[#818cf8] via-[#a5b4fc] to-[#c7d2fe] dark:from-[#0d0b2e] dark:via-[#1a1550] dark:to-[#251e6b]">
          {/* Subtle radial glow */}
