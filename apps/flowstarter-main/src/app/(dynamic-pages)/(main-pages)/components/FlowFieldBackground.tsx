...
export function FlowFieldBackground() {
  return (
    <>
      ...
      <div className="absolute lg:fixed inset-0 pointer-events-none overflow-hidden z-0 will-change-transform">
        <svg
          className="absolute inset-0 w-full h-full opacity-[0.07] dark:opacity-[0.10]"
