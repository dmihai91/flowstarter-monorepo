  ...
  return (
    <section className="relative pt-20 sm:pt-24 lg:pt-28 pb-2 lg:pb-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        ...
        {/* Body */}
        <p
          className="text-sm sm:text-lg text-gray-500 dark:text-white/55 leading-loose mb-5 max-w-lg mx-auto"
        ...
        >
          <span className="inline-block px-6 py-3 rounded-full bg-white/70 dark:bg-white/[0.06] border border-gray-200/50 dark:border-white/[0.08] text-sm sm:text-base text-gray-500 dark:text-white/50 font-medium backdrop-blur-sm leading-relaxed">
            {hero.trustLine}
          </span>
        </div>
