    ...
    <SectionWrapper id="problem" tinted className="relative">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-3">
        {problem.pains.map((pain) => (
          <div
            key={pain.title}
            className="rounded-3xl bg-[var(--landing-card-bg)] p-7 ring-1 ring-[var(--landing-card-border)] backdrop-blur-sm text-center md:text-left shadow-[0_10px_35px_rgba(15,23,42,0.06)] border-l-4 border-l-red-400/60 dark:border-l-red-400/40"
          >
