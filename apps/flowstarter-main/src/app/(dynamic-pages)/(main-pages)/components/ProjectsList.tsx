    ...
    return (
      <GlassCard noHover className="p-6 text-center">
        <div className="max-w-sm mx-auto">
          ...
          <h3 className="text-base font-semibold mb-1 text-[var(--fs-ink)]">
      ...
      {showActions && (
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
          <div className="space-y-1">
            ...
            <p className="text-[var(--fs-ink-dim)] text-sm">
              {t('projects.subtitle')}
            </p>
          </div>
            ...
            return (
              ...
              >
                <div className="relative z-10 flex flex-col gap-4 flex-1">
                  ...
                  <div className="flex items-start gap-3">
                    {p.status === 'draft' ? (
                      <div className="h-[48px] w-[48px] rounded-[8px] overflow-hidden shrink-0 relative flex items-center justify-center backdrop-blur-sm bg-white/20 dark:bg-[rgba(58,58,74,0.2)] border border-white/40 dark:border-white/10">
                        <FileText
                          className="h-5 w-5 text-[var(--fs-ink-faint)] opacity-60"
                          strokeWidth={1.5}
                        />
                      </div>
                    ) : (
                  ...
                  {p.description && (
                    <p className="text-xs sm:text-sm text-[var(--fs-ink-dim)] line-clamp-2">
                      {p.description}
                    </p>
                  )}

                  <div className="flex flex-col gap-1.5 text-xs text-[var(--fs-ink-faint)]">
