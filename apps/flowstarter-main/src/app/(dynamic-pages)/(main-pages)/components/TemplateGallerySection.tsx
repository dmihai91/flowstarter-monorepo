  ...
  return (
    ...
    >
      <Image
        ...
        alt={t.name}
        fill
        className="object-cover object-top transition-transform duration-700 ease-out group-hover:scale-[1.06] dark:brightness-[0.72] dark:saturate-90 dark:contrast-[1.05]"
        loading="lazy"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          */}
          ...
          <div className="hidden md:flex flex-col gap-5">
            ...
            <div className="grid grid-cols-3 gap-5">
              <div className="col-span-2">
                <Card t={T[5]} i={5} featured isInView={isInView} />
              </div>
              <div /> {/* spacer */}
            </div>
          </div>
