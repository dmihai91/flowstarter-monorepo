  ...
  return (
    <SectionWrapper id="testimonials">
      <div className="text-center mb-10">
        <SectionHeading className="text-center mb-3">{testimonials.title}</SectionHeading>
        <p className="text-sm font-medium text-[var(--purple)] tracking-wide">{testimonials.subtitle}</p>
      </div>
