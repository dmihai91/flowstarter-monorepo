  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0a0a0c] text-gray-900 dark:text-white font-display relative overflow-hidden transition-colors duration-300">
        ...
        {/* Header */}
        <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'} ${scrolled || mobileMenuOpen ? 'bg-white/70 dark:bg-[#0a0a0c]/70 backdrop-blur-2xl backdrop-saturate-150 border-b border-white/50 dark:border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.05)]' : ''}`}>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href="/login" className="text-sm text-gray-400 dark:text-white/30 hover:text-[var(--purple)] transition-colors font-medium">
                    Client Login
                  </Link>
                </div>
              </div>
              ...
              <div className="flex justify-center">
                <p className="text-xs text-gray-400 dark:text-white/20 flex items-center gap-1.5">
                  ...
                  <svg className="w-3.5 h-3.5" viewBox="0 0 20 20">
                    ...
                    <path fill="url(#heartGradientLanding)" fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                  </svg>
