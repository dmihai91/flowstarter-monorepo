...
const faqs = [
  {
    ...
    answer: "It's simple! Book a free discovery call with our team. We'll learn about your business, goals, and design preferences. Then we build your professional website in 1-2 weeks. Once it's live, you can customize it anytime using our AI editor.",
  },
  {
    question: 'How long does it take to build my website?',
    answer: "Most websites are completed within 1-2 weeks after your discovery call. We'll keep you updated throughout the process and let you know when it's ready for review.",
  },
  {
    question: 'What happens during the discovery call?',
    answer: "We spend 30 minutes learning about your business, your goals, and your brand. You don't need to prepare anything, just show up and tell us about what you do. After the call, we'll send you a summary and start building within 24 hours.",
  },
  {
    question: 'Can I make changes after my site is live?',
    answer: "That's the whole point! Your subscription includes our AI editor: update text, add pages, change your branding, improve your SEO. All without writing a single line of code.",
  },
  {
  ...
  },
  {
    ...
    answer: "Zero. We handle the technical setup. The AI editor is built for people who've never touched code. Just describe what you want to change, and the AI handles the rest.",
  },
  {
    question: 'What are AI credits?',
    answer: "Each AI credit lets you make one edit to your site: update text, change colors, add a section, tweak your layout, improve SEO, and more. Your Starter plan includes 300 credits per month, which is more than enough for most businesses (the average client uses about 30-50 per month). If you ever need more, you can top up with 100 extra credits for €5.",
  },
  {
    question: 'What if I want to cancel?',
    answer: "No lock-in. Cancel your subscription anytime. If you share feedback with us, we'll refund 50% of your setup fee. Either way, you can download all your site assets to use elsewhere.",
  },
  {
    question: 'Can I use my existing domain?',
    answer: "Absolutely. We'll help you connect your existing domain to your new site at no extra cost. If you don't have a domain yet, we can help you pick and set one up during the discovery call.",
  },
  {
    question: 'What kind of websites can you build?',
    answer: "We specialize in professional websites for freelancers, consultants, small businesses, restaurants, agencies, coaches, and creators. Whether you need a portfolio, a service page, a landing page, or a multi-page business site, we've got you covered.",
  },
];
    ...
    <>
      ...
      <div className="min-h-screen font-display bg-[#FAFAFA] dark:bg-[#0a0a0c]">
        ...
        <div className="fixed inset-0 pointer-events-none">
          ...
          >
            <defs>
              <linearGradient id="helpFlowGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                >
                  ...
                  {openFaq === i && (
                    <div className="px-6 pb-4">
                      <p className="text-gray-500 dark:text-white/50 leading-relaxed">{faq.answer}</p>
                    </div>
                  )}
                </div>
              ))}
