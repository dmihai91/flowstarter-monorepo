...
export function TeamHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] bg-white/60 dark:bg-[#0a0a0c]/70 backdrop-blur-2xl backdrop-saturate-150 border-b border-white/50 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
