      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-[var(--purple)] text-white text-xs flex items-center justify-center">
              1
            </span>
            Create GA4 Property
          </h3>
          <div className="pl-8">
            <p className="text-sm text-gray-600 dark:text-white/60 mb-3">
              Create a new property in Google Analytics for the client's
              website.
            </p>
            <Button variant="outline" asChild>
              <a
                href="https://analytics.google.com/analytics/web/#/a/p/admin/property/create"
                target="_blank"
        ...
        <div className="space-y-4">
          ...
          <div className="pl-8 space-y-3">
            <p className="text-sm text-gray-600 dark:text-white/60">
              Add this snippet to the site's{' '}
