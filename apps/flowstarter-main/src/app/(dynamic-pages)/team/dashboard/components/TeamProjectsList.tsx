    ...
    >
      ...
      {viewMode === 'list' && (
        <div className="space-y-2">
          <div className="hidden md:grid md:grid-cols-[48px_1fr_100px_150px_100px_40px] gap-4 px-4 py-2 text-xs font-medium text-[var(--fs-ink-faint)] uppercase tracking-wider">
            <div></div>
                ...
                >
                  ...
                  <div className="hidden md:grid md:grid-cols-[48px_1fr_100px_150px_100px_40px] gap-4 px-4 py-3 items-center">
                    ...
                    <div className="min-w-0">
                      <p className="font-medium text-[var(--fs-ink)] text-sm truncate">
                    ...
                    <div className="text-sm text-[var(--fs-ink-dim)] truncate">
                      {getOwnerDisplay(
                        project,
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`px-3 py-2 text-sm rounded-lg border transition-colors ${
                    pricingData.project_type === 'standard'
                      ...
                      : 'border-[var(--fs-rule)] hover:border-gray-300 dark:hover:border-white/20'
                  }`}
                >
                ...
                <button
                  type="button"
                  disabled
                  className="px-3 py-2 text-sm rounded-lg border border-[var(--fs-rule)] text-gray-400 dark:text-white/30 cursor-not-allowed"
                >
