  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-6">
          ...
          <section className="rounded-[32px] border border-gray-200/80 bg-white/95 p-6 backdrop-blur-xl backdrop-saturate-150 shadow-[0_8px_32px_rgba(0,0,0,0.08),0_1px_0_rgba(255,255,255,0.9)_inset] dark:border-white/[0.06] dark:bg-white/[0.05] dark:shadow-[0_8px_32px_rgba(0,0,0,0.25),0_1px_0_rgba(255,255,255,0.06)_inset]">
            <p className="text-sm font-medium text-zinc-900 dark:text-white mb-1">Industry</p>
          ...
          <div>
            <p className="text-sm font-medium text-zinc-900 dark:text-white mb-1">How do you want to proceed?</p>
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              You can change this later without losing any of the collected information.
            </p>
          </div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-zinc-900 dark:text-white">Generate with AI</p>
              <p className="mt-1 text-xs leading-5 text-zinc-500 dark:text-zinc-400">
                Start from a guided prompt and let AI produce the initial brief, structure, and recommendations.
              </p>
            </div>
            <div className={`mt-1 h-5 w-5 shrink-0 rounded-full border-2 flex items-center justify-center ${mode === 'ai' ? 'border-[var(--purple)]' : 'border-zinc-300 dark:border-zinc-600'}`}>
              {mode === 'ai' && <div className="h-2.5 w-2.5 rounded-full bg-[var(--purple)]" />}
            </div>
          </button>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-zinc-900 dark:text-white">Fill in manually</p>
              <p className="mt-1 text-xs leading-5 text-zinc-500 dark:text-zinc-400">
                Skip AI generation and go straight to the editable brief to capture the business details yourself.
              </p>
            </div>
            <div className={`mt-1 h-5 w-5 shrink-0 rounded-full border-2 flex items-center justify-center ${mode === 'manual' ? 'border-[var(--purple)]' : 'border-zinc-300 dark:border-zinc-600'}`}>
              {mode === 'manual' && <div className="h-2.5 w-2.5 rounded-full bg-[var(--purple)]" />}
            </div>
          </button>
          </section>
      </div>
      ...
      {mode === 'ai' && (
        <section className="rounded-[32px] border border-gray-200/80 bg-white/95 p-6 backdrop-blur-xl backdrop-saturate-150 shadow-[0_8px_32px_rgba(0,0,0,0.08),0_1px_0_rgba(255,255,255,0.9)_inset] dark:border-white/[0.06] dark:bg-white/[0.05] dark:shadow-[0_8px_32px_rgba(0,0,0,0.25),0_1px_0_rgba(255,255,255,0.06)_inset]">
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <p className="text-sm font-medium text-zinc-900 dark:text-white">Assistant prompt</p>
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-3">
            Describe the business, audience, offer, tone, or goals. The more specific you are, the better the generated brief will be.
          </p>
          <textarea
            value={prompt}
          ...
          <div className="mt-2 flex items-center justify-between gap-3 text-[11px] text-zinc-500 dark:text-zinc-400">
            <span>Include audience, offer, style, and the main action you want visitors to take.</span>
            <span className={prompt.trim().length < 20 ? 'text-amber-600 dark:text-amber-400' : ''}>
      ...
      <div className="flex items-center justify-end">
        <Button
          ...
          iconPosition="right"
        >
          {mode === 'ai' ? 'Generate project brief' : 'Continue to brief editor'}
        </Button>
      </div>
    </div>
  );
