...
function _BuildStep({
  ...
  return (
    <div className="space-y-5">
      ...
      <div
        className="rounded-[var(--fs-radius-2xl)] border p-5 space-y-3 backdrop-blur-2xl backdrop-saturate-150"
        style={{
          background: 'var(--fs-glass-bg)',
          borderColor: 'var(--fs-glass-edge)',
          boxShadow: 'var(--fs-card-shadow)',
  ...
  return (
    <div className="pt-8 pb-10 px-3 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content card */}
        <div
          className="rounded-[var(--fs-radius-2xl)] border px-4 py-6 sm:px-10 sm:py-10 backdrop-blur-2xl backdrop-saturate-150"
          style={{
            background: 'var(--fs-glass-bg)',
            borderColor: 'var(--fs-glass-edge)',
            boxShadow: 'var(--fs-card-shadow)',
