/**
 * POST /api/admin/projects/[id]/site/domains — attach a custom domain.
 * DELETE /api/admin/projects/[id]/site/domains?domain=xxx — detach one.
 *
 ...
 * `/api/team/...` twin of this route so the two cannot drift.
 */
export {
