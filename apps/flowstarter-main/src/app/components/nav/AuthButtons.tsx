...
export function AuthButtons({ size = 'default' }: AuthButtonsProps) {
  ...
  const signInClass =
    size === 'compact'
      ? '!h-9 sm:!h-11 box-border rounded-lg bg-[rgba(243,243,243,0.4)] dark:bg-[rgba(58,58,74,0.3)] backdrop-blur-xl border border-gray-300 dark:border-white/40 text-[var(--fs-ink)] hover:bg-[rgba(243,243,243,0.5)] dark:hover:bg-[rgba(58,58,74,0.4)] hover:border-gray-400 dark:hover:border-white/30 transition-all duration-300 px-2.5 sm:px-4 text-sm sm:text-base'
      : '!h-11 box-border rounded-lg bg-[rgba(243,243,243,0.4)] dark:bg-[rgba(58,58,74,0.3)] backdrop-blur-xl border border-gray-300 dark:border-white/40 text-[var(--fs-ink)] hover:bg-[rgba(243,243,243,0.5)] dark:hover:bg-[rgba(58,58,74,0.4)] hover:border-gray-400 dark:hover:border-white/30 transition-all px-4';
