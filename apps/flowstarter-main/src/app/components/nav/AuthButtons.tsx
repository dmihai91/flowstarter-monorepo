...
export function AuthButtons({ size = 'default' }: AuthButtonsProps) {
  ...
  const signUpClass =
    size === 'compact'
      ? '!h-9 sm:!h-10 box-border border border-transparent rounded-lg bg-gray-900 text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 transition-all px-2.5 sm:px-4 text-xs sm:text-sm'
