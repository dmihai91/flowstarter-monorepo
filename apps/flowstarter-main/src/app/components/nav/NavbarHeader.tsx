  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-500 ${
        isScrolled ? "border-b bg-white/60 dark:bg-[#0a0a0c]/60 backdrop-blur-2xl backdrop-saturate-150 border-gray-200/30 dark:border-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.03)]" : "border-b border-transparent bg-white/30 dark:bg-[#0a0a0c]/30 backdrop-blur-xl"} ${
        isScrolled
