...
export default function FooterCompact() {
  ...
  return (
    <footer className="relative z-20 bg-[rgba(243,243,243,0.30)] dark:bg-[rgba(58,58,74,0.30)] backdrop-blur-xl border-t border-white/40 dark:border-white/12 glass-shadow-shell-bottom">
          ...
          <div className="flex items-center justify-center lg:justify-end gap-4 text-xs text-gray-500 dark:text-gray-400 w-full lg:w-auto flex-wrap">
            <div className="flex items-center gap-2">
              <a
                ...
                className="w-7 h-7 bg-(--surface-1) rounded-full flex items-center justify-center [@media(hover:hover)]:hover:bg-blue-100 dark:[@media(hover:hover)]:hover:bg-blue-100 transition-colors"
                target="_blank"
              ...
              <a
                ...
                className="w-7 h-7 bg-(--surface-1) rounded-full flex items-center justify-center [@media(hover:hover)]:hover:bg-gray-200 dark:[@media(hover:hover)]:hover:bg-gray-200 transition-colors"
                target="_blank"
                rel="noopener noreferrer"
