    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-12 sm:mb-16">
        <button
          ...
          className="p-5 sm:p-6 rounded-2xl bg-white/55 dark:bg-white/[0.02] border border-gray-200/50 dark:border-white/5 hover:border-[var(--purple)]/40 transition-all group text-left"
        >
      ...
      <section className="mb-12 sm:mb-16">
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
          {steps.map((step, i) => (
            <div
              key={i}
              className="p-5 sm:p-6 rounded-2xl bg-white/55 dark:bg-white/[0.02] border border-gray-200/50 dark:border-white/5"
            >
