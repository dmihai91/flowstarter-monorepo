  ...
  return (
    <div className={cn('flex flex-col gap-3 min-w-0', className)}>
      <div className="flex items-start gap-[8px] min-w-0">
        <p className="text-md sm:text-base font-medium leading-normal text-[var(--fs-ink)] wrap-break-word ml-1">
            ...
            <div className="flex flex-col gap-3 min-w-0">
              {displayedPrompts.map((prompt, index) => (
                <motion.button
                  ...
                  className="group relative overflow-hidden rounded-[12px] bg-white/25 dark:bg-[rgba(58,58,74,0.2)] backdrop-blur-xl border border-gray-200/50 dark:border-white/15 px-5 py-2 text-left text-[0.925rem] font-normal leading-6 text-[var(--fs-ink-dim)] hover:bg-white/35 dark:hover:bg-[rgba(58,58,74,0.3)] transition-all duration-100 whitespace-normal wrap-break-word overflow-wrap-anywhere max-w-fit shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.08),0_4px_8px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.4)] dark:hover:shadow-[0_8px_16px_rgba(0,0,0,0.15),0_4px_8px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.1)]"
                  style={{
