  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          'z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md border border-zinc-800/80 bg-zinc-900 px-2 py-1 text-xs font-medium text-zinc-50 shadow-[0_8px_20px_rgba(0,0,0,0.18)]',
