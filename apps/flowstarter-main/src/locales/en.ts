const en = {
  ...
  'status.subtitle': 'Current operational status of Flowstarter services.',
  'status.allOperational': 'All systems operational',
  'status.someIssues': 'Some systems are experiencing issues',
  'status.services.website': 'Website',
  'status.services.editor': 'Flowstarter Editor',
  'status.services.api': 'API',
  'status.services.auth': 'Authentication',
  'status.services.hosting': 'Client Hosting',
