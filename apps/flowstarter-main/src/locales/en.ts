const en = {
  ...
  'help.step3.description': 'Your site goes live. Use the AI editor to update content, add pages, and tweak your design anytime.',
  'help.faqTitle': 'Frequently Asked Questions',
  'help.faq1.question': 'How does the process work?',
  'help.faq1.answer': "It's simple! Book a free discovery call with our team. We'll learn about your business, goals, and design preferences. Then we design and build your professional website in about 2 weeks. Once it's live, you can customize it anytime using our AI editor.",
  ...
  'help.faq4.answer': "That's the whole point! Your subscription includes our AI editor: update text, add pages, change your branding, improve your SEO. All without writing a single line of code.",
  ...
  'help.faq6.answer': "Zero. We handle the technical setup. The AI editor is built for people who've never touched code. Just describe what you want to change, and the AI handles the rest.",
  'help.faq7.question': 'What are AI credits?',
  'help.faq7.answer': 'AI credits let you make changes to your live site through the AI editor: update text, swap images, add sections, tweak layouts, and more. Your plan includes credits each month, which is more than enough for regular updates.',
  ...
  'privacy.s3.c2.text': 'When using our platform: account credentials (email, name, authentication method), project data (site structure, pages, components, design choices), AI editor interactions (prompts, edits, customization history), and platform usage data (features used, session information).',
  ...
  'privacy.s5.c1.text': "Flowstarter uses AI technology for: generating website code and components, powering the AI editor for content changes, providing design suggestions, and automating repetitive development tasks. When you use AI features, data is sent to AI providers for real-time processing.",
  ...
  'terms.s2.i1.text': 'Flowstarter provides website design, development, and hosting services. Our team builds your website based on a discovery call, and after launch you can customize it using our AI editor.',
