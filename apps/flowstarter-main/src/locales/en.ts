const en = {
  ...
  'landing.steps.step2.desc':
    'We build your website, set up booking, email, and analytics. You get a polished site ready to customize with our smart editor.',
  ...
  'landing.editor.subtitle':
    'Just describe what you want changed. Our smart editor rewrites copy, updates sections, and keeps your site current. No code, no waiting.',
