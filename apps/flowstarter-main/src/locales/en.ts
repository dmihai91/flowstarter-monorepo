const en = {
  ...
  'landing.steps.step2.desc':
    'We build your website, set up booking, email, and analytics. You get a polished site ready to customize with the smart editor.',
  ...
  // Landing Page - Editor
  'landing.editor.title': 'Then make it yours, anytime.',
  ...
  'landing.pricing.careFeature2': 'Smart editor: update text, images, pages',
  ...
  'landing.process.heading2': 'works',
  ...
  'landing.trust.email.desc': '@yourdomain.com included',
  'landing.trust.analytics.label': 'Visitor analytics',
  'landing.trust.analytics.desc': 'See who visits and when',
  'landing.trust.payments.label': 'Secure payments',
  'landing.trust.payments.desc': 'Accept bookings and payments',
  'landing.trust.ssl.label': 'SSL & daily backups',
  'landing.trust.ssl.desc': 'Protected and always recoverable',
  'landing.trust.maintenance.label': 'No maintenance headaches',
  ...
  // Mock Editor Preview
  'mockEditor.chatTitle': '\u2728 Smart Editor',
  ...
  'help.step3.description': 'Your site goes live. Use the smart editor to update content, add pages, and tweak your design anytime.',
  'help.faqTitle': 'Frequently Asked Questions',
  'help.faq1.question': 'How does the process work?',
  'help.faq1.answer': "It's simple! Book a free discovery call with our team. We'll learn about your business, goals, and design preferences. Then we design and build your professional website in about 2 weeks. Once it's live, you can customize it anytime using the smart editor.",
  ...
  'help.faq4.answer': "That's the whole point! Your subscription includes the smart editor: update text, add pages, change your branding, improve your SEO. All without writing a single line of code.",
  ...
  'help.faq6.answer': "Zero. We handle the technical setup. The smart editor is built for people who've never touched code. Just describe what you want to change, and the smart editor handles the rest.",
  'help.faq7.question': 'What are AI credits?',
  'help.faq7.answer': 'Editor credits let you make changes to your live site through the smart editor: update text, swap images, add sections, tweak layouts, and more. Your plan includes credits each month, which is more than enough for regular updates.',
  ...
  'about.description': 'Empowering small businesses to build their digital presence with AI-powered solutions',
  'about.mission.heading': 'Our Mission',
  'about.mission.description': 'We believe that every small business deserves a professional digital presence. Our mission is to make it easy and affordable for entrepreneurs to establish and grow their online business with cutting-edge AI technology.',
  'about.mission.simplify': 'Simplify digital presence creation for small businesses',
  'about.mission.leverage': 'Leverage AI to make professional design accessible',
  ...
  'about.values.description': 'These core values guide everything we do at Flowstarter',
  'about.values.innovation.title': 'Innovation',
  'about.values.innovation.description': "We constantly push the boundaries of what's possible with AI technology to provide the best solutions for our customers.",
  'about.values.accessibility.title': 'Accessibility',
  'about.values.accessibility.description': 'We believe in making professional digital tools accessible to businesses of all sizes, regardless of technical expertise.',
  'about.values.customerSuccess.title': 'Customer Success',
  'about.values.customerSuccess.description': "Your success is our success. We're committed to helping you achieve your business goals through our platform and support.",
  'about.joinTeam.heading': 'Join Our Team',
  'about.joinTeam.description': "We're always looking for talented individuals who share our passion for helping small businesses succeed.",
  ...
  'privacy.s5.c1.text': "Flowstarter uses AI technology for: generating website code and components, powering the smart editor for content changes, providing design suggestions, and automating repetitive development tasks. When you use AI features, data is sent to AI providers for real-time processing.",
  ...
  'terms.s2.i1.text': 'Flowstarter provides website design, development, and hosting services. Our team builds your website based on a discovery call, and after launch you can customize it using the smart editor.',
