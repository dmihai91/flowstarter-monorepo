export const legalKeys = {
  ...
  'privacy.s3.c2.text':
    'When using our platform: account credentials (email, name, authentication method), project data (site structure, pages, components, design choices), smart editor interactions (prompts, edits, customization history), and platform usage data (features used, session information).',
  ...
  'privacy.s5.c1.text':
    'Flowstarter uses AI technology for: generating website code and components, powering our smart editor for content changes, providing design suggestions, and automating repetitive development tasks. When you use AI features, data is sent to AI providers for real-time processing.',
  ...
  'terms.s2.i1.text':
    'Flowstarter provides website design, development, and hosting services. Our team builds your website based on a discovery call, and after launch you can customize it using our smart editor.',
