  ...
  test: {
    ...
    poolOptions: {
      forks: {
        ...
        execArgv: ['--max-old-space-size=4096'], // lower per-fork limit
      },
    },
    // Run tests within files concurrently and files in parallel
    maxConcurrency: 20,
    fileParallelism: true, // re-enable parallelism
    testTimeout: 10000,
    hookTimeout: 10000,
    coverage: {
      provider: 'v8',
