...
> **⚠️ Tier names and prices superseded.** Master doc (`docs/FLOWSTARTER_MASTER_DECISIONS.md`) is canonical. The "Pro" tier here corresponds to **Commerce** (Shopify store €1,799 founding / €2,999 standard + €99/€129 monthly subscription). The provider-routing logic and concierge delivery flow described below remain relevant for the Commerce tier; substitute "Commerce" for "Pro" throughout.
