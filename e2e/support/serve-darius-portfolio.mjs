/** Static server for the generated Darius portfolio (darius.flowstarter.dev). */
import { createServer } from 'node:http';
import { readFile, stat } from 'node:fs/promises';
import { join, extname, normalize } from 'node:path';

const ROOT = new URL('../../artifacts/darius-portfolio', import.meta.url).pathname;
...
}).listen(8901, '127.0.0.1', () => console.log('darius portfolio on :8901'));
