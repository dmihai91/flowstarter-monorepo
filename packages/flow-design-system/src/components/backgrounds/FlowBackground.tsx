...
const variants: Record<FlowBackgroundVariant, VariantConfig> = {
  dashboard: { bgLight: '#fafafa', bgDark: '#07070a', glowLight: 0.12, glowDark: 0.12, lineLight: 0,    lineDark: 0    },
  editor:    { bgLight: '#f8f8fa', bgDark: '#0a0a0c', glowLight: 0.14, glowDark: 0.10, lineLight: 0.04, lineDark: 0.05 },
  landing:   { bgLight: '#fafafa', bgDark: '#07070a', glowLight: 0.65, glowDark: 0.38, lineLight: 0.08, lineDark: 0.08 },
  auth:      { bgLight: '#fafafa', bgDark: '#07070a', glowLight: 0.12, glowDark: 0.12, lineLight: 0.08, lineDark: 0.06 },
...
export const FlowBackground = forwardRef<HTMLDivElement, FlowBackgroundProps>(
  ({ variant = 'dashboard', animated = true, className = '', style, ...props }, ref) => {
    ...
    const violetAccentOpacity = isDark ? 0.10 : 0.05;
