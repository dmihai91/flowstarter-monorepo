        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://twitter.com/flowstarter" target="_blank" rel="noopener noreferrer" aria-label="Follow Flowstarter on X (Twitter)" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center hover:bg-[var(--purple)]/10 transition-colors group">
              ...
              <a href="https://linkedin.com/company/flowstarter" target="_blank" rel="noopener noreferrer" aria-label="Follow Flowstarter on LinkedIn" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center hover:bg-[var(--purple)]/10 transition-colors group">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-[var(--purple)] transition-colors" fill="currentColor" viewBox="0 0 24 24">
